...
**basalt** is the native runtime environment and standard library of violetOS, designed to replace libc with a pure Zig interface. It bridges the kernel’s vector-asynchronous architecture with application logic, transforming raw batch primitives into ergonomic concurrency structures like async mutexes and channels.
